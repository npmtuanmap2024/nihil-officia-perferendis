...
-   <span class="package-name">[`@stdlib/string-from-code-point-cli`][@stdlib/string-from-code-point-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/string-from-code-point-cli]: https://www.npmjs.com/package/@stdlib/string-from-code-point-cli
